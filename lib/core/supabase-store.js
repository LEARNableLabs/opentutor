...
// Supabase, and reports no error, so a page shorter than this is the last one.
// ponytail: holds while the project's max rows is at least PAGE; lower that setting and lower PAGE with it.
const PAGE = 1000;
