...
import { completionsFile, recordCompletion, readCurriculumWithProgress, withoutRuntimeFields, domainFilePath, seedFromTemplate, workspaceDir } from './progress.js';
...
export class TutorStore {
  ...
  constructor(rootDir, { userId = null } = {}) {
    ...
    // '' rather than null: it is a PRIMARY KEY column, and NULL never equals NULL.
    this._uid = userId || '';
