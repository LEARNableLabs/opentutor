...
/** One conversational turn from the browser: text of at most 4,000 characters, else null.
 *  Refused rather than cut, so an answer is never graded on half of what the student wrote. */
export const turnText = (text) => (typeof text === 'string' && text.length <= 4000 ? text : null);
