 ...
 */
export function buildOnboardingPrompt(skills, userProfile = '') {
  ...
  const system = [
    ...
    reference
      ...
      : [
        ...
        'stick; you track what trips them up and bring it back later; 293 subjects are ready and',
        'anything else gets researched and built. Say it once, in your own words, then move on.',
      ].join(' '),
