...
export class OpenRouterAdapter extends OpenAIAdapter {
  constructor(options = {}) {
    ...
    super({
      ...
      cheapModel: options.cheapModel || process.env.OPENROUTER_CHEAP_MODEL || 'anthropic/claude-haiku-4-5-20251001',
      strongModel: options.strongModel || process.env.OPENROUTER_STRONG_MODEL || 'anthropic/claude-sonnet-4-20250514',
